...
const mainBody = {
  ...
  firstName: "Mario",
  middleName: "",
  lastName: "Herrero Anaya",
  message:
    "Technology enthusiast specialized in programming and software development.",
  icons: [
    {
      image: "fa-github",
...
const about = {
  show: true,
  heading: "About Me",
  imageLink: require("../editable-stuff/fotoPerfil.png"),
  imageSize: 375,
  message:
...
const repos = {
  ...
  gitHubUsername: "grumpyArdias", //i.e."johnDoe12Gh"
  reposLength: 0,
  // Edit this to specific github projects
  specificRepos: [
    "miranda-backoffice",
    "miranda-backend",
    "hotel-miranda",
  ...
  data: [
    {
      ...
      companylogo: require("../assets/img/oxygen.jpg"),
      date: "Feb 2023 – Present",
    },
    {
      role: "Project Manager",
      companylogo: require("../assets/img/inelcom.jpg"),
